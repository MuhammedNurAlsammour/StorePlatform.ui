...
import { ExportDataCustomerDefinitionsService } from './export-data-customer-definitions.service';
import { environment } from 'projects/shared/src/environments/environment.development';

describe('ExportCustomerDefinitionsService', () => {
  let service: ExportDataCustomerDefinitionsService;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        ExportDataCustomerDefinitionsService,
    ...
    service = TestBed.inject(ExportDataCustomerDefinitionsService);
