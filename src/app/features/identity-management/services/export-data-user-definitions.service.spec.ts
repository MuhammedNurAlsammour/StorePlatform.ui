...
import { ExportDataUserDefinitionsService } from './export-data-user-definitions.service';

describe('ExportDataUserDefinitionsService', () => {
  let service: ExportDataUserDefinitionsService;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        ExportDataUserDefinitionsService,
    ...
    service = TestBed.inject(ExportDataUserDefinitionsService);
