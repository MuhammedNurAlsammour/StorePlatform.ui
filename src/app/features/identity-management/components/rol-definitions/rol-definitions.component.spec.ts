...
import { DataRol } from '@features/identity-management/contracts/responses/list-rol-definitions';
import { NgxSpinnerService } from 'ngx-spinner';
import { environment } from 'projects/shared/src/environments/environment.development';
import { BehaviorSubject } from 'rxjs';
import { CreateComponent } from './create/create.component';
import { ListComponent } from './list/list.component';
import { RolDefinitionsComponent } from './rol-definitions.component';
import { CoderPioneersComponent, CoderPioneersListComponent } from '@coder-pioneers/ui-layout-components';

describe('RolDefinitionsComponent', () => {
  let component: RolDefinitionsComponent;
  let fixture: ComponentFixture<RolDefinitionsComponent>;
  ...
  let mockCoderPioneersList: jasmine.SpyObj<CoderPioneersListComponent<DataRol>>;
  ...
  beforeEach(async () => {
    ...
    coderPioneersListSpy.updateDataSource.and.callFake(
      function(this: CoderPioneersListComponent<DataRol>
    ) {
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: ActivatedRoute, useValue: { queryParams: mockQueryParams.asObservable() } },
    ...
    fixture = TestBed.createComponent(RolDefinitionsComponent);
