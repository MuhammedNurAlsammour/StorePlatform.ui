...
import { CoderPioneersListComponent, MaterialModule, PermissionsService } from '@coder-pioneers/shared';
...
describe('UserDefinitionsComponent', () => {
  ...
  let mockCoderPioneersList: jasmine.SpyObj<CoderPioneersListComponent<ResultUser>>;
  ...
  beforeEach(async () => {
    ...
    const coderPioneersListSpy = jasmine.createSpyObj('CoderPioneersListComponent', [
      ...
      displayedColumns: ['select', 'nameSurname', 'userName', 'roleName', 'customerName', 'actions'],
      config: {
        showCheckbox: true,
        showActions: true,
    ...
    coderPioneersListSpy.updateDataSource.and.callFake(
      function(this: CoderPioneersListComponent<ResultUser>
      ) {
