...
import { ResultDocumentTypeDefinition } from '@features/definitions/contracts/responses/document-type-definition-response';
...
import { DocumentTypeDefinitionComponent } from './document-type-definition.component';
import { ListComponent } from './list/list.component';

describe('DocumentTypeDefinitionComponent', () => {
  let component: DocumentTypeDefinitionComponent;
  let fixture: ComponentFixture<DocumentTypeDefinitionComponent>;
  ...
  let mockCoderPioneersList: 
  jasmine.SpyObj<CoderPioneersListComponent<ResultDocumentTypeDefinition>>;
  ...
  beforeEach(async () => {
    ...
    coderPioneersListSpy.updateDataSource.and.callFake(
      function(this: CoderPioneersListComponent<ResultDocumentTypeDefinition>
    ) {
    ...
    fixture = TestBed.createComponent(DocumentTypeDefinitionComponent);
