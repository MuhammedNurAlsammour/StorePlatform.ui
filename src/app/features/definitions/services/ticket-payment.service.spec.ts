...
describe('TicketPaymentService', () => {
  let service: TicketPaymentService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(TicketPaymentService);
    httpMock = TestBed.inject(HttpTestingController);
  });

  it('TicketPaymentService servisi testi', () => {
    expect(service).toBeTruthy();
  });

  it('GET /TicketPayment/GetTicketPaymentLists read endpointine istek atmalı ve veriyi döndürmeli', async () => {
    const mockResponse = {
      result: [{
        id: '1',
        name: 'Test',
    ...
    const req = httpMock.expectOne(
      req => req.url.includes(`${environment.apiUrls.baseUrl}/TicketPayment/GetTicketPaymentLists`)
    );
  ...
  it('GET /TicketPayment/GetTicketPaymentLists read endpointinde hata oluşursa uyarı', async () => {
  ...
  it('post /TicketPayment/InsertTicketPayment fonksiyonu başarılı olmalı', () => {
    const mockRequest = {
      id: '1',
      countryName: 'Test',
      countryCode: 1,
  ...
  it('post /TicketPayment/InsertTicketPayment fonksiyonu hata durumunda hata fırlatmalı', (done) => {
    const mockRequest = {
      id: '1',
      countryName: 'Test',
      countryCode: 1,
  ...
  it('update /TicketPayment/UpdateTicketPayment fonksiyonu başarılı olmalı', () => {
    const mockRequest = {
      id: '1',
      countryName: 'Test',
      countryCode: 1,
  ...
  it('update /TicketPayment/UpdateTicketPayment fonksiyonu hata durumunda alertService.error çağrılmalı', (done) => {
    const mockRequest = {
      id: '1',
      countryName: 'Test',
      countryCode: 1,
