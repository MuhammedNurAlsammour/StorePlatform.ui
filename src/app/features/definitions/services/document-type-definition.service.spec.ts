...
describe('DocumentTypeDefinitionService', () => {
  let service: DocumentTypeDefinitionService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(DocumentTypeDefinitionService);
    httpMock = TestBed.inject(HttpTestingController);
  });

  it('DocumentTypeDefinitionService servisi testi', () => {
    expect(service).toBeTruthy();
  });

  it('GET /DocumentType/GetDocumentTypeList read endpointine istek atmalı ve veriyi döndürmeli', async () => {
    const mockResponse = {
      result: [{
        id: '1',
        name: 'Test',
    ...
    const req = httpMock.expectOne(
      req => req.url.includes(`${environment.apiUrls.baseUrl}/DocumentType/GetDocumentTypeList`)
    );
  ...
  it('GET /DocumentType/GetDocumentTypeList read endpointinde hata oluşursa uyarı', async () => {
  ...
  it('post /DocumentType/InsertDocumentType fonksiyonu başarılı olmalı', () => {
    const mockRequest = {
      id: '1',
      countryName: 'Test',
      countryCode: 1,
  ...
  it('post /DocumentType/InsertDocumentType fonksiyonu hata durumunda hata fırlatmalı', (done) => {
    const mockRequest = {
      id: '1',
      countryName: 'Test',
      countryCode: 1,
  ...
  it('update /DocumentType/UpdateDocumentType fonksiyonu başarılı olmalı', () => {
    const mockRequest = {
      id: '1',
      countryName: 'Test',
      countryCode: 1,
  ...
  it('update /DocumentType/UpdateDocumentType fonksiyonu hata durumunda alertService.error çağrılmalı', (done) => {
    const mockRequest = {
      id: '1',
      countryName: 'Test',
      countryCode: 1,
