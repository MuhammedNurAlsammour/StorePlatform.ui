...
import { ExportDataTypeOfResignationService } from './export-data-type-of-resignation.service';

describe('ExportDataTypeOfResignationService', () => {
  let service: ExportDataTypeOfResignationService;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        ExportDataTypeOfResignationService,
    ...
    service = TestBed.inject(ExportDataTypeOfResignationService);
