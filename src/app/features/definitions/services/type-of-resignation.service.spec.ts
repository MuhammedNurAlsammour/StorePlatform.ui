...
import { TypeOfResignationService } from './type-of-resignation.service';

describe('TypeOfResignationService', () => {
  let service: TypeOfResignationService;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        TypeOfResignationService,
        { provide: AlertService, useValue: alertServiceSpy },
        { provide: 'baseUrl', useValue: environment.apiUrls.baseUrl }
      ]
    });
    service = TestBed.inject(TypeOfResignationService);
    httpMock = TestBed.inject(HttpTestingController);
  });

  it('TypeOfResignationService servisi testi', () => {
    expect(service).toBeTruthy();
  });

  it('GET /TypeOfResignation/GetResignationTypeList read endpointine istek atmalı ve veriyi döndürmeli', async () => {
    const mockResponse = {
      result: [{
        id: '1',
        name: 'Test',
    ...
    const req = httpMock.expectOne(
      req => req.url.includes(`${environment.apiUrls.baseUrl}/TypeOfResignation/GetResignationTypeList`)
    );
  ...
  it('GET /TypeOfResignation/GetResignationTypeList read endpointinde hata oluşursa uyarı', async () => {
  ...
  it('post /TypeOfResignation/InsertResignationType fonksiyonu başarılı olmalı', () => {
    const mockRequest = {
      id: '1',
      countryName: 'Test',
      countryCode: 1,
  ...
  it('post /TypeOfResignation/InsertResignationType fonksiyonu hata durumunda hata fırlatmalı', (done) => {
    const mockRequest = {
      id: '1',
      countryName: 'Test',
      countryCode: 1,
  ...
  it('update /TypeOfResignation/UpdateResignationType fonksiyonu başarılı olmalı', () => {
    const mockRequest = {
      id: '1',
      countryName: 'Test',
      countryCode: 1,
  ...
  it('update /TypeOfResignation/UpdateResignationType fonksiyonu hata durumunda alertService.error çağrılmalı', (done) => {
    const mockRequest = {
      id: '1',
      countryName: 'Test',
      countryCode: 1,
