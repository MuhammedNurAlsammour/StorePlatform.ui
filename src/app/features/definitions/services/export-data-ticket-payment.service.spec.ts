...
import { ExportDataTicketPaymentService } from './export-data-ticket-payment.service';


describe('ExportDataTicketPaymentService', () => {
  let service: ExportDataTicketPaymentService;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        ExportDataTicketPaymentService,
    ...
    service = TestBed.inject(ExportDataTicketPaymentService);
    httpMock = TestBed.inject(HttpTestingController);
  });

  it('ExportDataTicketPaymentService servisi testi', () => {
