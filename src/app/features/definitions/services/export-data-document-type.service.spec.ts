...
import { ExportDataDocumentTypeService } from './export-data-document-type.service';

describe('ExportDataDocumentTypeService', () => {
  let service: ExportDataDocumentTypeService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(ExportDataDocumentTypeService);
