...
describe('ExportDataOrderItemsService', () => {
  let service: ExportDataOrderItemsService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(ExportDataOrderItemsService);
