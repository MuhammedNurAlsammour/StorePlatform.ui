...
describe('ExportDataBusinessesService', () => {
  let service: ExportDataBusinessesService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(ExportDataBusinessesService);
