...
import { ProfessionalCsvExportService } from '@coder-pioneers/shared';
import { ProfessionalExcelExportService } from '@coder-pioneers/shared';
import { ProfessionalHtmlExportService } from '@coder-pioneers/shared';
import { ProfessionalJsonExportService } from '@coder-pioneers/shared';
import { ProfessionalTxtExportService } from '@coder-pioneers/shared';
import { ExportFormat } from '@coder-pioneers/shared';
import { AlertService } from '@coder-pioneers/shared';
import { environment } from 'src/environments/environment';
import { ExportDataProductService } from './export-data-product.service';

describe('ExportDataProductService', () => {
  let service: ExportDataProductService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(ExportDataProductService);
