...
import { ExportDataCategoriesService } from './export-data-categories.service';

describe('ExportDataCategoriesService', () => {
  let service: ExportDataCategoriesService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(ExportDataCategoriesService);
