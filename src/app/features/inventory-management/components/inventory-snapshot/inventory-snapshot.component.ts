...
@Component({
  ...
  styleUrl: './inventory-snapshot.component.scss'
})
export class InventorySnapshotComponent extends BaseComponent implements OnInit {
...
ngOnInit(): void {
  if (
    !this.permissionsService.ifPermit('GET.Reading.ÜrünstokanlıkgörüntüleritablosuListesiGetirir')
    ){
