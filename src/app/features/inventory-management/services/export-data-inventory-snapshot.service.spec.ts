...
describe('ExportDataInventorySnapshotService', () => {
  let service: ExportDataInventorySnapshotService;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        ExportDataInventorySnapshotService,
    ...
    service = TestBed.inject(ExportDataInventorySnapshotService);
