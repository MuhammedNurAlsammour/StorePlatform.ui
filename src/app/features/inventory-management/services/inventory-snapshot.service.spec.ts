...
describe('InventorySnapshotService', () => {
  ...
  it('InventorySnapshotService servisi testi', () => {
    expect(service).toBeTruthy();
  });

  it('GET /InventorySnapshot/GetAllInventorySnapshot read endpointine istek atmalı ve veriyi döndürmeli', async () => {
    const mockResponse = {
      result: [{
        id: '1',
        name: 'Test',
    ...
    const req = httpMock.expectOne(
      req => req.url.includes(`${environment.apiUrls.baseUrl}/InventorySnapshot/GetAllInventorySnapshot`)
    );
  ...
  it('GET /InventorySnapshot/GetAllInventorySnapshot read endpointinde hata oluşursa uyarı', async () => {
  ...
  it('GET /InventorySnapshot/GetByIdInventorySnapshot readById endpointine istek atmalı ve veriyi döndürmeli', async () => {
    const mockResponse = {
      result: [{
        id: '1',
        name: 'Test',
    ...
    const req = httpMock.expectOne(
      req => req.url.includes(`${environment.apiUrls.baseUrl}/InventorySnapshot/GetByIdInventorySnapshot`)
    );
    expect(req.request.method).toBe('GET');
    req.flush(mockResponse);
    const data = await promise;
  ...
  it('GET /InventorySnapshot/GetByIdInventorySnapshot readById endpointinde hata oluşursa uyarı', async () => {
    const errorMsg = 'Server ile iletişim kurulamadı. Lütfen daha sonra tekrar deneyiniz.';
    const promise = service.readId({ id: '1' },true);
    const req = httpMock.expectOne(
      req => req.url.includes(`${environment.apiUrls.baseUrl}/InventorySnapshot/GetByIdInventorySnapshot`)
  ...
  it('post /InventorySnapshot/CreateInventorySnapshot fonksiyonu başarılı olmalı', () => {
    const mockRequest = {
      id: '1',
      countryName: 'Test',
      countryCode: 1,
  ...
  it('post /InventorySnapshot/CreateInventorySnapshot fonksiyonu hata durumunda hata fırlatmalı', (done) => {
    const mockRequest = {
      id: '1',
      countryName: 'Test',
      countryCode: 1,
  ...
  it('update /InventorySnapshot/UpdateInventorySnapshot fonksiyonu başarılı olmalı', () => {
    const mockRequest = {
      id: '1',
      countryName: 'Test',
      countryCode: 1,
  ...
  it('update /InventorySnapshot/UpdateInventorySnapshot fonksiyonu hata durumunda alertService.error çağrılmalı', (done) => {
    const mockRequest = {
      id: '1',
      countryName: 'Test',
      countryCode: 1,
