...
export class LoginsComponent extends LoginComponent<any> {
  ...
  // #region şirket resmi
  override companyImage = 'assets/login/Logo1.png';
  // #endregion

  // #region modul resmi
  override modulImage = 'assets/login/Logo1.png';
  // #endregion
  ...
  override afterLoginPageRoute: string = '/management';
  // #endregion
  ...
  sliderImages = [
    {
      ...
      description: 'Etkili görev takibi, başarılı proje yönetiminin temelidir. Modern iş dünyasında, her görevin zamanında ve doğru şekilde tamamlanması kritik önem taşır. Bizim görev takip sistemimiz, ekiplerinizin verimliliğini artırırken, iş süreçlerinizi şeffaf ve ölçülebilir hale getirir.'
    },
    {
      path: 'assets/login/iki.png',
      title: 'Sistemin Gücü,',
      subtitle: 'Başarıya Birlikte Koş!',
      description: 'Görev takip platformumuz, kullanıcı dostu arayüzü, gerçek zamanlı bildirim sistemi ve kapsamlı raporlama özellikleriyle öne çıkar. Her ekip üyesi, kendisine atanan görevleri kolayca takip edebilir, ilerlemelerini paylaşabilir ve iş arkadaşlarıyla etkili bir şekilde iletişim kurabilir. Bu sayede, ekip çalışması ve proje koordinasyonu yeni bir boyut kazanır.'
    },
    {
      path: 'assets/login/uc.png',
      title: 'Geleceğin İş Yönetimi,',
      subtitle: 'Başarıya Birlikte Koş!',
      description: 'İş dünyası sürekli değişiyor ve biz bu değişime ayak uyduracak çözümler sunuyoruz. Ekiplerinizin potansiyelini maksimuma çıkarın, verimliliği artırın ve rekabet avantajı elde edin. Geleceğin iş yönetimi için bizimle adım atın.'
    }
  ];
  // #endregion
